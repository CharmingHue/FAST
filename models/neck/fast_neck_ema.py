...
class FASTNeck(nn.Module):
    def __init__(self, reduce_layer1, reduce_layer2, reduce_layer3, reduce_layer4, same=False):
    ...
    @staticmethod
    def build_from_config(config, same=False):
        ...
        return FASTNeck(reduce_layer1, reduce_layer2, reduce_layer3, reduce_layer4, same)
